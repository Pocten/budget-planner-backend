...
DROP TABLE IF EXISTS  roles, access_levels, users, dashboards, financial_records, categories, category_priorities, tags, financial_record_tag, budgets, financial_goals, invite_links, dashboard_access, dashboard_roles CASCADE;
